...
servicio_bp.route('/<int:servicio_id>/activar', methods=['POST'])(ServicioController.activar_servicio)
servicio_bp.route('/<int:servicio_id>/desactivar', methods=['POST'])(ServicioController.desactivar_servicio)
servicio_bp.route('/<int:servicio_id>/solicitar', methods=['GET', 'POST'])(ServicioController.solicitar_servicio)
servicio_bp.route('/buscar')(ServicioController.buscar_servicios)
servicio_bp.route('/catalogo')(ServicioController.catalogo_servicios)
